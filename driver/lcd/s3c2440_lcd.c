...
- 2015-8-11,Menglong Wu,MenglongWoo@163.com
	- 修改成24bpp
- 2015-8-13,Menglong Wu,MenglongWoo@163.com
	- 在 LR043JC211.c 的基础上将其改成s3c2440通用的LCD驱动程序，配置文件在lcdconf.h
...
#ifndef _UNUSE_S3C2440_LCD_DEBUG
void readlcdreg()
{
...
void lcd_init()
{
	...
	preg_lcd->lcdcon1 = (4 << 8) | (3 << 5) | (0xD << 1) | (0 << 0);//24bpp
	// preg_lcd->lcdcon1 = (4 << 8) | (3 << 5) | (0xC << 1) | (0 << 0);//16bpp 除此之外还要设置其他别的东西
